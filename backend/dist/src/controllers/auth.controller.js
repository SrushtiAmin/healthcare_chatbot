...
class AuthController {
    static async signup(req, res, next) {
        try {
            ...
            (0, errors_utils_1.handleApiError)(error, res, 'AuthController.signup');
        }
    }
    static async login(req, res, next) {
        try {
            ...
            (0, errors_utils_1.handleApiError)(error, res, 'AuthController.login');
        }
    }
    static async getMe(req, res, next) {
        try {
            ...
            (0, errors_utils_1.handleApiError)(error, res, 'AuthController.getMe');
        }
    }
}
