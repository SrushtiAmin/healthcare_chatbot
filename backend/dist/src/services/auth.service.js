...
class AuthService {
    ...
    static async signup(signupData) {
        ...
        const existingUser = await prisma_lib_1.default.user.findUnique({
        ...
        const newUser = await prisma_lib_1.default.user.create({
            data: {
    ...
    static async login(loginData) {
        // Find user by email
        const user = await prisma_lib_1.default.user.findUnique({
    ...
    static async getUsers() {
        const users = await prisma_lib_1.default.user.findMany();
